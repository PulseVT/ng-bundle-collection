  ...
  return module.factory('Collection', [
    '$q', '$timeout', function($q, $timeout) {
      ...
      return Collection = (function() {
        function Collection(rest1, config) {
          this.rest = rest1;
        ...
        Collection.prototype.create = function(data) {
          ...
          this.promises.create = $q.when(this.promises.create).then(function() {
            return promise;
          });
          this.promises.global = $q.when(this.promises.global).then(function() {
            return promise;
          });
          return promise;
        };
        ...
        Collection.prototype.__update = function(data, method) {
          ...
          this.promises[method] = $q.when(this.promises[method]).then(function() {
            return promise;
          });
          this.promises.update = $q.when(this.promises.update).then(function() {
            return promise;
          });
          this.promises.global = $q.when(this.promises.global).then(function() {
            return promise;
        ...
        Collection.prototype["delete"] = function(item) {
          ...
          this.promises["delete"] = $q.when(this.promises["delete"]).then(function() {
            return promise;
          });
          this.promises.global = $q.when(this.promises.global).then(function() {
            return promise;
        ...
        Collection.prototype.__private_fetch = function(params) {
          ...
          this.promises.fetch = $q.when(this.promises.fetch).then(function() {
